...
@interface avTouchController : NSObject <UIPickerViewDelegate, UIPickerViewDataSource, AVAudioPlayerDelegate> {
	...
	IBOutlet UIPickerView		*songPicker;
	NSArray						*pickerData;
}
...
@property (nonatomic, retain)	UIPickerView	*songPicker;
